  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to QA Restaurant Booking Engine - Streamlining Your Dining Experience. Customers Reserve. Employees Manage. Everyone Wins."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to QA Restaurant Booking Engine - Streamlining Your Dining Experience. Customers Reserve. Employees Manage. Everyone Wins.`}
            </Text>
            <Box
